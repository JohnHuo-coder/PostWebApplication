				...
				<div className="bg-white px-6 py-12 shadow-sm sm:rounded-lg sm:px-12 dark:bg-gray-800/90 dark:shadow-none dark:outline dark:-outline-offset-1 dark:outline-white/10">
					<form onSubmit={postNewPost}>
						<div className="space-y-12">
							<div className="border-b border-gray-900/10 pb-5 dark:border-white/10">
                                ...
                                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div className="flex justify-center items-center">
                                        <button type="button" onClick={addTask} className="mt-5">+ add more task</button>
                                    </div>
                        ...
                        <div className="flex gap-3 pt-5">
                            ...
                            <div className="text-sm/6">
                                <label htmlFor="showinfo" className="font-medium text-gray-900 dark:text-white">
                                Show personal information
                                </label>
                            </div>
                        </div>
						...
						<div className="mt-6 flex items-center justify-end gap-x-6">
							<button
								type="submit"
                                disabled={tasks.length === 0 || posting || loading}
								className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:col-start-2 dark:bg-indigo-500 dark:shadow-none dark:hover:bg-indigo-400 dark:focus-visible:outline-indigo-500"
								>
                                {posting || loading ? <><svg className="size-5 animate-spin" viewBox="0 0 24 24">
                                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round" strokeDasharray="15 47"/>
									<circle className="opacity-25" cx="12" cy="12" r="10" stroke="gray" strokeWidth="4" fill="none" strokeLinecap="round"/>
                                    </svg> Posting… </>
                                        : <p>Post</p>}
