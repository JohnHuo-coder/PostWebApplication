...
export default function SignIn() {
    ...
    const { user, needOnboard, loading, refreshAuth } = useAuth();

    useEffect(() => {
        if (!loading && user && needOnboard){
            console.log("User logged in but need Onboarding. Redirecting...");
    ...
    <>
        <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
                <div className="bg-white px-6 py-12 shadow-sm sm:rounded-lg sm:px-12 dark:bg-gray-800/80 dark:shadow-none dark:outline dark:-outline-offset-1 dark:outline-white/10">
                    <form onSubmit={verifyUser} className="space-y-6">
                        ...
                        <div>
                            <button
                                ...
                                className="flex w-full items-center justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:bg-indigo-500 dark:shadow-none dark:hover:bg-indigo-400 dark:focus-visible:outline-indigo-500"
                            >
                                {pageLoading || loading ? <><svg className="mr-3 size-5 animate-spin" viewBox="0 0 24 24">
                ...
                <p className="mt-10 text-center text-sm/6 text-gray-500 dark:text-gray-800">
                    No account? Please{' '}
                    <Link className="font-semibold text-indigo-200 hover:text-indigo-300" to="/signup">Sign up</Link>
                </p>
            </div>
        </div>
    </>
